...
public class GeneExpressionDAO extends PhenominerDAO {
    ...
    public List<GeneExpression> getGeneExpressionObjectsByTermRgdIdUnit(String termAcc, int rgdId, String unit) throws Exception{
        String query = """
                select ge.*,gr.*,s.*, st.study_id, st.ref_rgd_id from gene_expression_values ge, gene_expression_exp_record gr, sample s, experiment e, study st, ont_terms t\s
    ...
    public List<GeneExpression> getGeneExpressionObjectsByRgdIdUnit(int rgdId, String unit) throws Exception{
        String query = """
                select ge.*,gr.*,s.*, st.study_id, st.ref_rgd_id from gene_expression_values ge, gene_expression_exp_record gr, sample s, experiment e, study st, ont_terms t\s
                where ge.gene_expression_exp_record_id = gr.gene_expression_exp_record_id\s                                                                               
